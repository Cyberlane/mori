...
module.exports = grammar({
  ...
  rules: {
    ...
    export_specifier: $ => seq(
      ...
      optional(seq(
        'as',
        field('alias', choice($._module_export_name, alias($._reserved_identifier, $.identifier), alias(choice('if', 'const', 'return', 'for', 'while', 'switch', 'case', 'break', 'continue', 'throw', 'try', 'catch', 'finally', 'else', 'do', 'var', 'let', 'class', 'extends', 'new', 'delete', 'void', 'typeof', 'in', 'instanceof', 'with', 'debugger', 'function', 'import', 'export', 'true', 'false', 'null', 'this', 'super', 'yield'), $.identifier))),
      )),
    ),
