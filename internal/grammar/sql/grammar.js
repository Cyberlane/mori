module.exports = grammar({
  ...
  rules: {
    ...
    keyword_glob: _ => make_keyword("glob"),
    ...
    pragma_statement: $ => seq($.keyword_pragma, $.object_reference,
      optional(choice(seq('=', choice($.literal, $.identifier)), wrapped_in_parenthesis(choice($.literal, $.identifier))))),
    ...
    create_trigger: $ => seq(
      ...
      repeat(
        choice(
          ...
          seq($.keyword_when, optional_parenthesis($._expression)),
        ),
      ),
      choice(
        seq($.keyword_execute, choice($.keyword_function, $.keyword_procedure), $.object_reference, paren_list(field('parameter', $.term))),
        seq($.keyword_begin, repeat1(seq(choice($._dml_read, $._dml_write), ';')), $.keyword_end)
      ),
    ),
    ...
    binary_expression: $ => choice(
      ...[
        ...
        [seq($.keyword_not, $.keyword_glob), 'pattern_matching'],
