...
func DiscoverContext(ctx context.Context, paths []string, options Options) (Result, error) {
	...
	for _, requestedPath := range paths {
		...
		if !info.IsDir() {
			...
			addFile(&result, seen, unsupportedSeen, unsupportedCounts, cwd, filepath.Dir(absolutePath), absolutePath, true, options)
			continue
		}
		...
		walkErr := filepath.WalkDir(root, func(path string, entry fs.DirEntry, walkErr error) error {
			...
			addFile(&result, seen, unsupportedSeen, unsupportedCounts, cwd, absolutePath, path, false, options)
			return nil
		})
		if walkErr != nil {
...
func addFile(
	...
	result.Files = append(result.Files, File{
		...
		ClassificationPath: classificationPath(cwd, classificationRoot, cleanPath),
		Language:           spec,
...
func detectGeneratedHeader(path string, expected os.FileInfo) (bool, string, error) {
	...
	generated, marker := detectGeneratedContent(content)
	return generated, marker, nil
}

func detectGeneratedContent(content []byte) (bool, string) {
	if len(content) > maxGeneratedHeaderBytes {
		content = content[:maxGeneratedHeaderBytes]
	}
	...
	for _, line := range strings.Split(string(content), "\n") {
		...
		switch {
		case strings.HasPrefix(lower, "ansi-c code produced by gperf version ") && validGperfVersion(strings.TrimPrefix(lower, "ansi-c code produced by gperf version ")):
			return true, "gperf-generated"
		case strings.HasPrefix(lower, "generated by typeshare"):
			return true, "typeshare-generated"
		case strings.HasPrefix(lower, "generated by the swift generator plugin for the protocol buffer compiler"):
			return true, "swift-protobuf-generated"
		case strings.Contains(lower, "code generated") && strings.Contains(lower, "do not edit"):
			return true, "code-generated-do-not-edit"
		case strings.Contains(lower, "this file was automatically generated"):
			return true, "automatically-generated"
		case strings.Contains(lower, "this file is generated") && strings.Contains(lower, "do not edit"):
			return true, "generated-do-not-edit"
		case strings.Contains(lower, "auto-generated") && strings.Contains(lower, "do not edit"):
			return true, "auto-generated-do-not-edit"
		case strings.Contains(lower, "@generated"):
			return true, "at-generated"
		}
	}
	return false, ""
}
...
// validGperfVersion deliberately recognizes the generator's numeric version
// header, not arbitrary comments that merely mention gperf.
func validGperfVersion(value string) bool {
...
// classificationPath excludes ambient absolute ancestors from test evidence.
func classificationPath(cwd, root, path string) string {
	relative, err := filepath.Rel(cwd, path)
